...
import static com.ihomefnt.module.common.api.impl.ModuleUtil.destroyQuietly;
 ...
 * 定时刷新模块
 */
public abstract class AbstractModuleRefreshScheduler implements InitializingBean, DisposableBean,
    Runnable {
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    scheduledExecutor = new ScheduledThreadPoolExecutor(1,
        new BasicThreadFactory.Builder().namingPattern("module_refresh-schedule-pool-%d")
            .daemon(true).build());
    scheduledExecutor
