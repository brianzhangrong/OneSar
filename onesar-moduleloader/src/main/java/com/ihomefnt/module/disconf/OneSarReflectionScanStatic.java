...
public class OneSarReflectionScanStatic implements ScanStaticStrategy {
  ...
  private Reflections getReflection(List<String> packNameList) {
    ...
    try {
      urlTotals.add(new URL("file:/Users/zhangrong/Documents/workspace/ihomefnt/irayproxy/irayproxy"
          + "/target/classes/"));
